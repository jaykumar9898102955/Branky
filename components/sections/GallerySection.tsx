  ...
  return (
    <section id="gallery" style={{ background:'linear-gradient(145deg,#1255e8 0%,#0a3db5 55%,#082e8a 100%)',padding:'96px 5%',position:'relative',overflow:'hidden' }}>
      ...
      <div style={{ maxWidth:1200,margin:'0 auto',position:'relative',zIndex:1 }}>
        ...
        <div className="reveal d1" style={{ borderRadius:18,overflow:'hidden',border:'2.5px solid rgba(255,255,255,.12)' }}>
          <div className="banner-track" style={{ display:'flex',width:'200%' }}>
            <div style={{ position:'relative',width:'50%',height:'clamp(220px,30vw,380px)',flexShrink:0 }}>
