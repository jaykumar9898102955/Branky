...
export default function AboutPage() {
  return (
    <>
      ...
      <main>
        {/* Page Hero */}
        <section style={{ padding:'120px 5% 80px', background:'var(--blue)', position:'relative', overflow:'hidden' }}>
...
<div className="tag tag-white">About Branky STEM Labs</div>
            <h1 className="h-display" style={{ fontSize:'clamp(2rem,2vw,3.4rem)', color:'#fff', marginBottom:16, lineHeight:1.1, maxWidth:680 }}>
